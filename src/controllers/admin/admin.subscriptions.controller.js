...
exports.activateSubscription = exports.cancelSubscription = exports.getAllSubscriptions = void 0;
...
const getAllSubscriptions = async (req, res) => {
    try {
        ...
        return (0, response_1.successResponse)(res, 'Subscriptions retrieved successfully', {
            items,
...
const cancelSubscription = async (req, res) => {
    try {
        ...
        if (!subscription)
            return (0, response_1.errorResponse)(res, 'Subscription not found', 404);
        if (subscription.status === 'EXPIRED' || subscription.status === 'CANCELLED') {
            return (0, response_1.errorResponse)(res, 'Subscription cannot be cancelled', 400);
        }
        ...
        return (0, response_1.successResponse)(res, 'Subscription cancelled successfully', updatedSubscription);
    }
    catch (error) {
        console.error(error);
        return (0, response_1.errorResponse)(res, 'Internal server error', 500);
...
const activateSubscription = async (req, res) => {
    try {
        ...
        if (!restaurantId || !planId) {
            return (0, response_1.errorResponse)(res, 'restaurantId and planId are required', 400);
        }
        ...
        return (0, response_1.successResponse)(res, 'Subscription activated/extended successfully', subscription);
    }
    catch (error) {
        console.error(error);
        return (0, response_1.errorResponse)(res, 'Internal server error', 500);
