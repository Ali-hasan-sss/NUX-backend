 ...
 */
const getAdsForAll = async (req, res) => {
    try {
        ...
        if (lat && lng && radius) {
            ...
            ads = ads.filter((ad) => {
                const distance = (0, check_location_1.calculateDistance)(userLat, userLng, ad.restaurant.latitude, ad.restaurant.longitude);
                return distance / 1000 <= r;
            });
        }
        return (0, response_1.successResponse)(res, 'Ads fetched successfully', ads);
    }
    catch (error) {
        console.error(error);
...
exports.getAdsForAll = getAdsForAll;
//# sourceMappingURL=ads.client.controller.js.map